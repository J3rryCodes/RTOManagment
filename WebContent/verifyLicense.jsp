...
function viewForm(id){
	window.open("ViewLicenseForm?id="+id,"View Form","wdth=200,height=200");
}
function approveRequest(id){
	document.getElementById("message").style.display = "inline";
	window.location="ApproveLicenseRequest?id="+id;
}
function rejectForm(id){
	window.location="RejectLicenseForm?id="+id;
}
		...
		<c:if test="${forms ne null}">
			<table class="table-s">
				<tr>
					...
					<th width=16% colspan="3" style="text-align: center;">Operations</th>
				</tr>
