...
<body>
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="item active">
					...
					<div class="carousel-caption kb_caption">
						...
						<h4 data-animation="animated flipInX">RTO Kerala</h4>
					</div>
				</div>
	...
	<div class="content">
		...
		<div class="welcome-w3">
			<div class="container">
				<h2 class="tittle">Welcome To RTO Kerala</h2>
				<div class="wel-grids">
			...
			<div class="container">
				...
				<div class="student-grids">
					<div class="col-md-6 student-grid">
						...
						<p>We are a governmental organization and we operate in all
							the districts of Kerala We have skilled officers and
							inspectors who smoothly run the organization</p>
						<p>The things we do are</p>
						<ul class="grid-part">
							<li><i class="glyphicon glyphicon-ok-sign"> </i>Issue
								driving license</li>
							<li><i class="glyphicon glyphicon-ok-sign"> </i>Issue
								vehicle registration certificate</li>
							<li><i class="glyphicon glyphicon-ok-sign"> </i>Amend
								traffic rules and regulations</li>
							<li><i class="glyphicon glyphicon-ok-sign"> </i>Conduct
								awareness programmes on road safety, pollution control etc.</li>
						</ul>

					</div>
					<div class="col-md-6 student-grid">
						<img src="images/kerala-map.jpg" class="img-responsive" alt="Image-2">
					</div>
					<!--<div class="clearfix"></div>-->
				</div>
			</div>
				...
				<div class="new-grids">
					<div class="col-md-6 new-left">
						...
						<div class="new-top">
							...
							<p>Children's Day</p>
							<p>
								We are organizing a free workshop for students of various
								schools on road safety and traffic rules. Today's children are
								tomorrow's citizens and it is necessary to educate students
								about this. We request all the schools to encourage their
								students to participate in this event. Lunch and tea will be
								provided.<br> Venue: RTO Office
							</p>
						</div>
						<div class="new-top1">
							<h5>Friday November 17</h5>
							<p>Anti pollution drive</p>
							<p>RTO officials together with Let's Do It (NGO) will carry
								out an anti pollution drive in the streets of the city. This
								drive is aimed at creating awareness about air pollution and its
								ill effects among citizens. This will encourage people to
								conduct pollution tests on their vehicles regularly. Interested
								citizens can join us. Venue: ABC Circle</p>
						</div>
						<div class="new-top">
							<h5>Monday November 20</h5>
							<p>Inauguration of new RTO building</p>
							<p>The newly constructed RTO building will be inaugurated by
								honourable Chief Minister of Kerala. We request citizens to
					...
					<div class="col-md-6 new-right">
						...
						<p>The honourable Chief Minister of Kerala will inaugurate
							the new RTO building on the 19th of November</p>
						<div class="new-bottom">
							...
							<div class="new-bottom-right">
								...
								<p>Mr.John has been appointed as the new RTO officer. He
									will be taking charge from Mr.Ram on the 10th of November.
									Mr.Ram has been transferred to the Education Department.</p>
							</div>
							<div class="clearfix"></div>
						</div>
						<h4>Online vehicle registration</h4>
						<p>Along with  DL we have now added the application forms
							for vehicle registration as well. This will make the registration
							process easy and more efficient.</p>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
				...
				<div class="col-md-4 footer-grid">
					...
					<ul>
						<li><i class="glyphicon glyphicon-map-marker"
							aria-hidden="true"></i>Thiruvananthapuram</li>
						<li><i class="glyphicon glyphicon-earphone"
							aria-hidden="true"></i>9483671226</li>
